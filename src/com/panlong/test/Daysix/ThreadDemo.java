...
根据案例简述：
    ...
    窗口1线程进入操作的时候，窗口2和窗口3和窗口4线程只能在外等着，窗口1操作结束，窗口1和窗口2和窗口3和窗口4才有机会进入代码去执行。也就是说在某个线程修改共享资源的时候，其他线程不能修改该资源，等待修改完毕同步之后，才能去抢夺CPU资源，完成对应的操作，保证了数据的同步性，解决了线程不安全的现象。
